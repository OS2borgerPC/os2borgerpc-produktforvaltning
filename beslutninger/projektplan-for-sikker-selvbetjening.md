...
Projektet gennemføres i overensstemmelse med den beskrevne projektplan:

- [Projektplan for OS2borgerPC v3](https://github.com/OS2borgerPC/os2borgerpc-produktforvaltning/blob/main/dokumenter/os2borgerpc-v3/projektplan.md)

Beslutningen baserer sig på den tidligere godkendte beslutning:
...
- Projektet kan igangsættes og styres efter den fremlagte projektplan
- Projektorganisationen kan arbejde videre med de beskrevne aktiviteter og milepæle
- Styregruppen løbende følger projektets fremdrift med udgangspunkt i projektplanen
- Eventuelle væsentlige ændringer i scope, tidsplan eller økonomi forelægges styregruppen til ny beslutning
